...
<body>
  ...
  <div class="login-container">
    ...
    <form action="/Controllers/LoginController.php" method="POST">
      ...
      <?php if (!empty($error)): ?>
        <p style="color: red;"><?php echo isset($error) ? htmlspecialchars($error) : ''; ?></p>
      <?php endif ?>
      
    </form>
    <a href="/Controllers/SignupController.php" class="signup-link">Don't have an account? Sign up</a>
  </div>
